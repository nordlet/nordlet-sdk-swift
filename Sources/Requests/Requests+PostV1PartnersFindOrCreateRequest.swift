...
extension Requests {
    public struct PostV1PartnersFindOrCreateRequest: Codable, Hashable, Sendable {
        public let type: PostV1PartnersFindOrCreateRequestType?
        ...
        public init(
            type: PostV1PartnersFindOrCreateRequestType? = nil,
            name: String,
            code: String? = nil,
            vatCode: String? = nil,
            peppolId: String? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.type = try container.decodeIfPresent(PostV1PartnersFindOrCreateRequestType.self, forKey: .type)
