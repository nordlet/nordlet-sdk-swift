...
extension Requests {
    public struct PostV1HrLeaveBalancesSetRequest: Codable, Hashable, Sendable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.usedDays = try container.decodeIfPresent(String.self, forKey: .usedDays)
        ...
        public func encode(to encoder: Encoder) throws -> Void {
            ...
            try container.encodeIfPresent(self.usedDays, forKey: .usedDays)
        }
