...
extension Requests {
    public struct PostV1TransportWaybillsCreateRequest: Codable, Hashable, Sendable {
        ...
        public let lines: [PostV1TransportWaybillsCreateRequestLinesItem]?
        ...
        public init(
            ...
            notes: String? = nil,
            series: String? = nil,
            lines: [PostV1TransportWaybillsCreateRequestLinesItem]? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.dispatchAt = try container.decode(Date.self, forKey: .dispatchAt)
            ...
            self.lines = try container.decodeIfPresent([PostV1TransportWaybillsCreateRequestLinesItem].self, forKey: .lines)
