...
extension Requests {
    public struct PostV1DeclarationsLtSdGenerateRequest: Codable, Hashable, Sendable {
        public let type: PostV1DeclarationsLtSdGenerateRequestType
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.type = try container.decode(PostV1DeclarationsLtSdGenerateRequestType.self, forKey: .type)
