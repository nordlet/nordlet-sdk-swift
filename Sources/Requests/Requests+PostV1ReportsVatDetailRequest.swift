...
extension Requests {
    public struct PostV1ReportsVatDetailRequest: Codable, Hashable, Sendable {
        public let fromDate: String
        public let toDate: String
        public let side: PostV1ReportsVatDetailRequestSide?
        ...
        public init(
            fromDate: String,
            toDate: String,
            side: PostV1ReportsVatDetailRequestSide? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.side = try container.decodeIfPresent(PostV1ReportsVatDetailRequestSide.self, forKey: .side)
