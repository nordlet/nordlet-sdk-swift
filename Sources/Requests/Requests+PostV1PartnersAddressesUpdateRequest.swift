...
extension Requests {
    public struct PostV1PartnersAddressesUpdateRequest: Codable, Hashable, Sendable {
        public let type: PostV1PartnersAddressesUpdateRequestType?
        ...
        public init(
            type: PostV1PartnersAddressesUpdateRequestType? = nil,
            street: String? = nil,
            city: String? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.type = try container.decodeIfPresent(PostV1PartnersAddressesUpdateRequestType.self, forKey: .type)
