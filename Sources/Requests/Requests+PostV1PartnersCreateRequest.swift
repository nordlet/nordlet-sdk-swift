...
extension Requests {
    public struct PostV1PartnersCreateRequest: Codable, Hashable, Sendable {
        public let type: PostV1PartnersCreateRequestType?
        ...
        public let address: PostV1PartnersCreateRequestAddress?
        public let notes: String?
        /// Additional properties that are not explicitly defined in the schema
        public let additionalProperties: [String: JSONValue]

        public init(
            type: PostV1PartnersCreateRequestType? = nil,
            name: String,
            code: String? = nil,
            vatCode: String? = nil,
            peppolId: String? = nil,
            ...
            groupId: String? = nil,
            statusId: String? = nil,
            address: PostV1PartnersCreateRequestAddress? = nil,
            notes: String? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.type = try container.decodeIfPresent(PostV1PartnersCreateRequestType.self, forKey: .type)
            ...
            self.address = try container.decodeIfPresent(PostV1PartnersCreateRequestAddress.self, forKey: .address)
