...
public struct PostV1CaptureDocumentsExtractResponse: Codable, Hashable, Sendable {
    public let id: String
    public let fileId: String
    public let fileName: String
    public let mimeType: String
    public let sizeBytes: Int64
    public let status: PostV1CaptureDocumentsExtractResponseStatus
    public let provider: Nullable<String>
    public let model: Nullable<String>
    public let pagesProcessed: Nullable<Int64>
    public let extraction: Nullable<PostV1CaptureDocumentsExtractResponseExtraction>
    ...
    public init(
        ...
        mimeType: String,
        sizeBytes: Int64,
        status: PostV1CaptureDocumentsExtractResponseStatus,
        provider: Nullable<String>,
        model: Nullable<String>,
        pagesProcessed: Nullable<Int64>,
        extraction: Nullable<PostV1CaptureDocumentsExtractResponseExtraction>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1CaptureDocumentsExtractResponseStatus.self, forKey: .status)
        ...
        self.extraction = try container.decode(Nullable<PostV1CaptureDocumentsExtractResponseExtraction>.self, forKey: .extraction)
