...
public struct PostV1CaptureDocumentsExtractResponseExtraction: Codable, Hashable, Sendable {
    public let supplier: PostV1CaptureDocumentsExtractResponseExtractionSupplier
    ...
    public let lines: [PostV1CaptureDocumentsExtractResponseExtractionLinesItem]
    ...
    public init(
        ...
        lines: [PostV1CaptureDocumentsExtractResponseExtractionLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.supplier = try container.decode(PostV1CaptureDocumentsExtractResponseExtractionSupplier.self, forKey: .supplier)
        ...
        self.lines = try container.decode([PostV1CaptureDocumentsExtractResponseExtractionLinesItem].self, forKey: .lines)
