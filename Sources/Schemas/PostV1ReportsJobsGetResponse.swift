...
public struct PostV1ReportsJobsGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let reportType: String
    public let params: JSONValue
    public let formats: [String]
    public let status: PostV1ReportsJobsGetResponseStatus
    public let error: Nullable<String>
    public let outputs: Nullable<[PostV1ReportsJobsGetResponseOutputsItem]>
    ...
    public init(
        ...
        params: JSONValue,
        formats: [String],
        status: PostV1ReportsJobsGetResponseStatus,
        error: Nullable<String>,
        outputs: Nullable<[PostV1ReportsJobsGetResponseOutputsItem]>,
        createdAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1ReportsJobsGetResponseStatus.self, forKey: .status)
        self.error = try container.decode(Nullable<String>.self, forKey: .error)
        self.outputs = try container.decode(Nullable<[PostV1ReportsJobsGetResponseOutputsItem]>.self, forKey: .outputs)
