...
public struct PostV1TransportWaybillsListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let status: PostV1TransportWaybillsListResponseRowsItemStatus
    ...
    public init(
        id: String,
        status: PostV1TransportWaybillsListResponseRowsItemStatus,
        series: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1TransportWaybillsListResponseRowsItemStatus.self, forKey: .status)
