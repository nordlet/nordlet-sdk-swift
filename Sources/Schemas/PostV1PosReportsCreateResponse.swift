...
public struct PostV1PosReportsCreateResponse: Codable, Hashable, Sendable {
    ...
    public let vatLines: [PostV1PosReportsCreateResponseVatLinesItem]
    ...
    public init(
        ...
        createdAt: String,
        vatLines: [PostV1PosReportsCreateResponseVatLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.vatLines = try container.decode([PostV1PosReportsCreateResponseVatLinesItem].self, forKey: .vatLines)
