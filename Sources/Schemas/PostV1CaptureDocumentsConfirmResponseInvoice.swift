...
public struct PostV1CaptureDocumentsConfirmResponseInvoice: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1CaptureDocumentsConfirmResponseInvoiceType
    public let status: PostV1CaptureDocumentsConfirmResponseInvoiceStatus
    public let paymentStatus: PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus
    ...
    public let lines: [PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1CaptureDocumentsConfirmResponseInvoiceType,
        status: PostV1CaptureDocumentsConfirmResponseInvoiceStatus,
        paymentStatus: PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1CaptureDocumentsConfirmResponseInvoiceType.self, forKey: .type)
        self.status = try container.decode(PostV1CaptureDocumentsConfirmResponseInvoiceStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1CaptureDocumentsConfirmResponseInvoicePaymentStatus.self, forKey: .paymentStatus)
        ...
        self.lines = try container.decode([PostV1CaptureDocumentsConfirmResponseInvoiceLinesItem].self, forKey: .lines)
