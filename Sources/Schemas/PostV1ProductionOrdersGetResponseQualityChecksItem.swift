...
public struct PostV1ProductionOrdersGetResponseQualityChecksItem: Codable, Hashable, Sendable {
    public let id: String
    public let orderId: String
    public let routingOperationId: Nullable<String>
    public let name: String
    public let result: PostV1ProductionOrdersGetResponseQualityChecksItemResult
    ...
    public init(
        ...
        name: String,
        result: PostV1ProductionOrdersGetResponseQualityChecksItemResult,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.result = try container.decode(PostV1ProductionOrdersGetResponseQualityChecksItemResult.self, forKey: .result)
