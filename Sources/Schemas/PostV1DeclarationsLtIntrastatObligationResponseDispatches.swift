...
public struct PostV1DeclarationsLtIntrastatObligationResponseDispatches: Codable, Hashable, Sendable {
    public let previousYearValue: String
    public let obligatedFromMonth: Nullable<Int64>
    public let statisticalValueRequired: Bool
    public let monthly: [PostV1DeclarationsLtIntrastatObligationResponseDispatchesMonthlyItem]
    ...
    public init(
        ...
        monthly: [PostV1DeclarationsLtIntrastatObligationResponseDispatchesMonthlyItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.monthly = try container.decode([PostV1DeclarationsLtIntrastatObligationResponseDispatchesMonthlyItem].self, forKey: .monthly)
