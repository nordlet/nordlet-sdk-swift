...
public struct PostV1PurchasesOrdersCloseResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let status: PostV1PurchasesOrdersCloseResponseStatus
    ...
    public let lines: [PostV1PurchasesOrdersCloseResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        status: PostV1PurchasesOrdersCloseResponseStatus,
        orderNumber: String,
        orderDate: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1PurchasesOrdersCloseResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PurchasesOrdersCloseResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1PurchasesOrdersCloseResponseLinesItem].self, forKey: .lines)
