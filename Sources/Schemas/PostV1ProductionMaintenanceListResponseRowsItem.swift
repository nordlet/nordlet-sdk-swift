...
public struct PostV1ProductionMaintenanceListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let workCenterId: String
    public let type: PostV1ProductionMaintenanceListResponseRowsItemType
    public let status: PostV1ProductionMaintenanceListResponseRowsItemStatus
    ...
    public init(
        id: String,
        workCenterId: String,
        type: PostV1ProductionMaintenanceListResponseRowsItemType,
        status: PostV1ProductionMaintenanceListResponseRowsItemStatus,
        plannedDate: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1ProductionMaintenanceListResponseRowsItemType.self, forKey: .type)
        self.status = try container.decode(PostV1ProductionMaintenanceListResponseRowsItemStatus.self, forKey: .status)
