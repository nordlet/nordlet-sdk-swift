...
public struct PostV1LedgerOwnersCreateResponse: Codable, Hashable, Sendable {
    ...
    public let address: Nullable<PostV1LedgerOwnersCreateResponseAddress>
    ...
    public init(
        ...
        address: Nullable<PostV1LedgerOwnersCreateResponseAddress>,
        createdAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.address = try container.decode(Nullable<PostV1LedgerOwnersCreateResponseAddress>.self, forKey: .address)
