...
public struct PostV1TransportWaybillsGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let status: PostV1TransportWaybillsGetResponseStatus
    ...
    public let lines: [PostV1TransportWaybillsGetResponseLinesItem]
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        id: String,
        status: PostV1TransportWaybillsGetResponseStatus,
        series: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1TransportWaybillsGetResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1TransportWaybillsGetResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1TransportWaybillsGetResponseLinesItem].self, forKey: .lines)
