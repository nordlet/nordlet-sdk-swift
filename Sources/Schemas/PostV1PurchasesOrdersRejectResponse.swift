...
public struct PostV1PurchasesOrdersRejectResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let status: PostV1PurchasesOrdersRejectResponseStatus
    ...
    public let lines: [PostV1PurchasesOrdersRejectResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        status: PostV1PurchasesOrdersRejectResponseStatus,
        orderNumber: String,
        orderDate: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1PurchasesOrdersRejectResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PurchasesOrdersRejectResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1PurchasesOrdersRejectResponseLinesItem].self, forKey: .lines)
