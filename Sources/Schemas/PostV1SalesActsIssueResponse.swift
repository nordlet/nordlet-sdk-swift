...
public struct PostV1SalesActsIssueResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesActsIssueResponseType
    public let status: PostV1SalesActsIssueResponseStatus
    ...
    public let lines: [PostV1SalesActsIssueResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesActsIssueResponseType,
        status: PostV1SalesActsIssueResponseStatus,
        series: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1SalesActsIssueResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesActsIssueResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesActsIssueResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1SalesActsIssueResponseLinesItem].self, forKey: .lines)
