...
public struct PostV1CaptureDocumentsConfirmRequestLinesItem: Codable, Hashable, Sendable {
    public let itemId: String?
    public let description: String?
    public let unit: String?
    public let quantity: PostV1CaptureDocumentsConfirmRequestLinesItemQuantity?
    ...
    public init(
        ...
        unit: String? = nil,
        quantity: PostV1CaptureDocumentsConfirmRequestLinesItemQuantity? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.quantity = try container.decodeIfPresent(PostV1CaptureDocumentsConfirmRequestLinesItemQuantity.self, forKey: .quantity)
