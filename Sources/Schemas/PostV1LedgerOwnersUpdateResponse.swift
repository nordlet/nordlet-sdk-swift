...
public struct PostV1LedgerOwnersUpdateResponse: Codable, Hashable, Sendable {
    ...
    public let address: Nullable<PostV1LedgerOwnersUpdateResponseAddress>
    ...
    public init(
        ...
        address: Nullable<PostV1LedgerOwnersUpdateResponseAddress>,
        createdAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.address = try container.decode(Nullable<PostV1LedgerOwnersUpdateResponseAddress>.self, forKey: .address)
