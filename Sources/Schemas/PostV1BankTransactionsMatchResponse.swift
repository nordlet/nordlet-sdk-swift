...
public struct PostV1BankTransactionsMatchResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1BankTransactionsMatchResponseStatus
    ...
    public init(
        ...
        status: PostV1BankTransactionsMatchResponseStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1BankTransactionsMatchResponseStatus.self, forKey: .status)
