...
public struct PostV1PartnersInquiriesCreateResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1PartnersInquiriesCreateResponseStatus
    ...
    public init(
        ...
        channel: String,
        status: PostV1PartnersInquiriesCreateResponseStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PartnersInquiriesCreateResponseStatus.self, forKey: .status)
