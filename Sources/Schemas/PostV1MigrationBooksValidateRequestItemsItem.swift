...
public struct PostV1MigrationBooksValidateRequestItemsItem: Codable, Hashable, Sendable {
    public let code: String
    public let name: String
    public let type: PostV1MigrationBooksValidateRequestItemsItemType?
    ...
    public init(
        code: String,
        name: String,
        type: PostV1MigrationBooksValidateRequestItemsItemType? = nil,
        unit: String? = nil,
        barcode: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decodeIfPresent(PostV1MigrationBooksValidateRequestItemsItemType.self, forKey: .type)
