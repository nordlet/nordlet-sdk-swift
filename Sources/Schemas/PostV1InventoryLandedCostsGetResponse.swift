...
public struct PostV1InventoryLandedCostsGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let date: String
    public let amount: String
    public let method: PostV1InventoryLandedCostsGetResponseMethod
    public let goodsReceiptId: Nullable<String>
    public let sourceInvoiceId: Nullable<String>
    public let notes: Nullable<String>
    public let createdAt: String
    public let lines: [PostV1InventoryLandedCostsGetResponseLinesItem]
    ...
    public init(
        ...
        date: String,
        amount: String,
        method: PostV1InventoryLandedCostsGetResponseMethod,
        goodsReceiptId: Nullable<String>,
        sourceInvoiceId: Nullable<String>,
        notes: Nullable<String>,
        createdAt: String,
        lines: [PostV1InventoryLandedCostsGetResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.method = try container.decode(PostV1InventoryLandedCostsGetResponseMethod.self, forKey: .method)
        ...
        self.lines = try container.decode([PostV1InventoryLandedCostsGetResponseLinesItem].self, forKey: .lines)
