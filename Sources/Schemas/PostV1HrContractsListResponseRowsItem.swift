...
public struct PostV1HrContractsListResponseRowsItem: Codable, Hashable, Sendable {
    ...
    public let type: PostV1HrContractsListResponseRowsItemType
    public let startDate: String
    public let endDate: Nullable<String>
    public let endReason: Nullable<String>
    public let baseSalary: String
    public let salaryType: PostV1HrContractsListResponseRowsItemSalaryType
    public let workHoursPerWeek: String
    public let status: PostV1HrContractsListResponseRowsItemStatus
    ...
    public init(
        ...
        baseSalary: String,
        salaryType: PostV1HrContractsListResponseRowsItemSalaryType,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1HrContractsListResponseRowsItemType.self, forKey: .type)
        ...
        self.salaryType = try container.decode(PostV1HrContractsListResponseRowsItemSalaryType.self, forKey: .salaryType)
        self.workHoursPerWeek = try container.decode(String.self, forKey: .workHoursPerWeek)
        self.status = try container.decode(PostV1HrContractsListResponseRowsItemStatus.self, forKey: .status)
