...
public struct PostV1ConsolidationReportResponseCashFlowOperating: Codable, Hashable, Sendable {
    public let inflow: String
    public let outflow: String
    public let net: String
    public let rows: [PostV1ConsolidationReportResponseCashFlowOperatingRowsItem]
    ...
    public init(
        ...
        outflow: String,
        net: String,
        rows: [PostV1ConsolidationReportResponseCashFlowOperatingRowsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rows = try container.decode([PostV1ConsolidationReportResponseCashFlowOperatingRowsItem].self, forKey: .rows)
