...
public struct PostV1HrEmployeesAnonymizeResponse: Codable, Hashable, Sendable {
    ...
    public let address: Nullable<PostV1HrEmployeesAnonymizeResponseAddress>
    ...
    public init(
        ...
        address: Nullable<PostV1HrEmployeesAnonymizeResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.address = try container.decode(Nullable<PostV1HrEmployeesAnonymizeResponseAddress>.self, forKey: .address)
