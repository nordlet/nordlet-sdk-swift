...
public struct PostV1BankSettlementsPostResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1BankSettlementsPostResponseStatus
    ...
    public let summary: PostV1BankSettlementsPostResponseSummary
    ...
    public init(
        ...
        feeTotal: String,
        netTotal: String,
        status: PostV1BankSettlementsPostResponseStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1BankSettlementsPostResponseStatus.self, forKey: .status)
        ...
        self.summary = try container.decode(PostV1BankSettlementsPostResponseSummary.self, forKey: .summary)
