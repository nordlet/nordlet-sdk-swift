...
public struct PostV1CatalogItemsListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1CatalogItemsListResponseRowsItemType
    public let tracking: PostV1CatalogItemsListResponseRowsItemTracking
    ...
    public let translations: Nullable<[String: Nullable<PostV1CatalogItemsListResponseRowsItemTranslationsValue>]>
    public let components: [PostV1CatalogItemsListResponseRowsItemComponentsItem]
    ...
    public init(
        ...
        translations: Nullable<[String: Nullable<PostV1CatalogItemsListResponseRowsItemTranslationsValue>]>,
        components: [PostV1CatalogItemsListResponseRowsItemComponentsItem],
        createdAt: String,
        updatedAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1CatalogItemsListResponseRowsItemType.self, forKey: .type)
        self.tracking = try container.decode(PostV1CatalogItemsListResponseRowsItemTracking.self, forKey: .tracking)
        ...
        self.translations = try container.decode(Nullable<[String: Nullable<PostV1CatalogItemsListResponseRowsItemTranslationsValue>]>.self, forKey: .translations)
        self.components = try container.decode([PostV1CatalogItemsListResponseRowsItemComponentsItem].self, forKey: .components)
