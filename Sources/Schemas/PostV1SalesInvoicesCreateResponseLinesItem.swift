...
public struct PostV1SalesInvoicesCreateResponseLinesItem: Codable, Hashable, Sendable {
    ...
    public let recognitionMethod: PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod
    public let recognitionStartDate: Nullable<String>
    public let recognitionEndDate: Nullable<String>
    public let recognitionMilestones: Nullable<[PostV1SalesInvoicesCreateResponseLinesItemRecognitionMilestonesItem]>
    ...
    public init(
        ...
        lineGross: String,
        sortOrder: Int64,
        recognitionMethod: PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod,
        recognitionStartDate: Nullable<String>,
        recognitionEndDate: Nullable<String>,
        recognitionMilestones: Nullable<[PostV1SalesInvoicesCreateResponseLinesItemRecognitionMilestonesItem]>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.recognitionMethod = try container.decode(PostV1SalesInvoicesCreateResponseLinesItemRecognitionMethod.self, forKey: .recognitionMethod)
        ...
        self.recognitionMilestones = try container.decode(Nullable<[PostV1SalesInvoicesCreateResponseLinesItemRecognitionMilestonesItem]>.self, forKey: .recognitionMilestones)
