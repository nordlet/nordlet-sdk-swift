...
public struct PostV1BankMandatesCancelResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let reference: String
    public let scheme: PostV1BankMandatesCancelResponseScheme
    public let sequenceType: PostV1BankMandatesCancelResponseSequenceType
    public let status: PostV1BankMandatesCancelResponseStatus
    ...
    public init(
        ...
        partnerId: String,
        reference: String,
        scheme: PostV1BankMandatesCancelResponseScheme,
        sequenceType: PostV1BankMandatesCancelResponseSequenceType,
        status: PostV1BankMandatesCancelResponseStatus,
        debtorName: String,
        iban: String,
        bic: Nullable<String>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.scheme = try container.decode(PostV1BankMandatesCancelResponseScheme.self, forKey: .scheme)
        self.sequenceType = try container.decode(PostV1BankMandatesCancelResponseSequenceType.self, forKey: .sequenceType)
        self.status = try container.decode(PostV1BankMandatesCancelResponseStatus.self, forKey: .status)
