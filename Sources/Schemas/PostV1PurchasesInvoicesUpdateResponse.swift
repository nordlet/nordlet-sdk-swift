...
public struct PostV1PurchasesInvoicesUpdateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1PurchasesInvoicesUpdateResponseType
    public let status: PostV1PurchasesInvoicesUpdateResponseStatus
    public let paymentStatus: PostV1PurchasesInvoicesUpdateResponsePaymentStatus
    ...
    public let lines: [PostV1PurchasesInvoicesUpdateResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1PurchasesInvoicesUpdateResponseType,
        status: PostV1PurchasesInvoicesUpdateResponseStatus,
        paymentStatus: PostV1PurchasesInvoicesUpdateResponsePaymentStatus,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1PurchasesInvoicesUpdateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PurchasesInvoicesUpdateResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1PurchasesInvoicesUpdateResponseStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1PurchasesInvoicesUpdateResponsePaymentStatus.self, forKey: .paymentStatus)
        ...
        self.lines = try container.decode([PostV1PurchasesInvoicesUpdateResponseLinesItem].self, forKey: .lines)
