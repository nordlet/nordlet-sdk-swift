...
public struct PostV1SalesInvoicesCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesInvoicesCreateResponseType
    public let status: PostV1SalesInvoicesCreateResponseStatus
    public let paymentStatus: PostV1SalesInvoicesCreateResponsePaymentStatus
    ...
    public let vatScheme: Nullable<PostV1SalesInvoicesCreateResponseVatScheme>
    ...
    public let vatEvidence: Nullable<PostV1SalesInvoicesCreateResponseVatEvidence>
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesInvoicesCreateResponseType,
        status: PostV1SalesInvoicesCreateResponseStatus,
        paymentStatus: PostV1SalesInvoicesCreateResponsePaymentStatus,
        ...
        vatScheme: Nullable<PostV1SalesInvoicesCreateResponseVatScheme>,
        ...
        vatEvidence: Nullable<PostV1SalesInvoicesCreateResponseVatEvidence>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesInvoicesCreateResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesInvoicesCreateResponseStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1SalesInvoicesCreateResponsePaymentStatus.self, forKey: .paymentStatus)
        ...
        self.vatScheme = try container.decode(Nullable<PostV1SalesInvoicesCreateResponseVatScheme>.self, forKey: .vatScheme)
        ...
        self.vatEvidence = try container.decode(Nullable<PostV1SalesInvoicesCreateResponseVatEvidence>.self, forKey: .vatEvidence)
