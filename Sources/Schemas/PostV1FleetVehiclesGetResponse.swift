...
public struct PostV1FleetVehiclesGetResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1FleetVehiclesGetResponseStatus
    public let notes: Nullable<String>
    public let currentAssignment: Nullable<PostV1FleetVehiclesGetResponseCurrentAssignment>
    ...
    public init(
        ...
        currentAssignment: Nullable<PostV1FleetVehiclesGetResponseCurrentAssignment>,
        createdAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1FleetVehiclesGetResponseStatus.self, forKey: .status)
        self.notes = try container.decode(Nullable<String>.self, forKey: .notes)
        self.currentAssignment = try container.decode(Nullable<PostV1FleetVehiclesGetResponseCurrentAssignment>.self, forKey: .currentAssignment)
