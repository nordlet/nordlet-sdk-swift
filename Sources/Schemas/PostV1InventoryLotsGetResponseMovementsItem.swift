...
public struct PostV1InventoryLotsGetResponseMovementsItem: Codable, Hashable, Sendable {
    public let id: String
    public let warehouseId: String
    public let itemId: String
    public let lotId: Nullable<String>
    public let date: String
    public let direction: PostV1InventoryLotsGetResponseMovementsItemDirection
    ...
    public init(
        ...
        date: String,
        direction: PostV1InventoryLotsGetResponseMovementsItemDirection,
        quantity: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.direction = try container.decode(PostV1InventoryLotsGetResponseMovementsItemDirection.self, forKey: .direction)
