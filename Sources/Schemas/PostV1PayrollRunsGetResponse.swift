...
public struct PostV1PayrollRunsGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let year: Int64
    public let month: Int64
    public let status: PostV1PayrollRunsGetResponseStatus
    ...
    public let lines: [PostV1PayrollRunsGetResponseLinesItem]
    ...
    public init(
        ...
        year: Int64,
        month: Int64,
        status: PostV1PayrollRunsGetResponseStatus,
        grossTotal: String,
        npdTotal: String,
        gpmTotal: String,
        ...
        lines: [PostV1PayrollRunsGetResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PayrollRunsGetResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1PayrollRunsGetResponseLinesItem].self, forKey: .lines)
