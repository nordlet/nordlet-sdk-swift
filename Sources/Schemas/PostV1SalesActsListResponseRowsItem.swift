...
public struct PostV1SalesActsListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesActsListResponseRowsItemType
    public let status: PostV1SalesActsListResponseRowsItemStatus
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesActsListResponseRowsItemType,
        status: PostV1SalesActsListResponseRowsItemStatus,
        series: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesActsListResponseRowsItemType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesActsListResponseRowsItemStatus.self, forKey: .status)
