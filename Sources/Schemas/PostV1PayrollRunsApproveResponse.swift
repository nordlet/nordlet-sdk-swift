...
public struct PostV1PayrollRunsApproveResponse: Codable, Hashable, Sendable {
    public let id: String
    public let year: Int64
    public let month: Int64
    public let status: PostV1PayrollRunsApproveResponseStatus
    ...
    public init(
        ...
        year: Int64,
        month: Int64,
        status: PostV1PayrollRunsApproveResponseStatus,
        grossTotal: String,
        npdTotal: String,
        gpmTotal: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PayrollRunsApproveResponseStatus.self, forKey: .status)
