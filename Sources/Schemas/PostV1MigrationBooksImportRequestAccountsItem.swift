...
public struct PostV1MigrationBooksImportRequestAccountsItem: Codable, Hashable, Sendable {
    public let code: String
    public let name: String
    public let type: PostV1MigrationBooksImportRequestAccountsItemType
    ...
    public init(
        code: String,
        name: String,
        type: PostV1MigrationBooksImportRequestAccountsItemType,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1MigrationBooksImportRequestAccountsItemType.self, forKey: .type)
