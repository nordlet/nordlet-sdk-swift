...
public struct PostV1ConsolidationMembersAddResponse: Codable, Hashable, Sendable {
    public let memberCompanyId: String
    public let name: String
    public let baseCurrency: String
    public let ownershipPercent: String
    public let method: PostV1ConsolidationMembersAddResponseMethod
    ...
    public init(
        ...
        method: PostV1ConsolidationMembersAddResponseMethod,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.method = try container.decode(PostV1ConsolidationMembersAddResponseMethod.self, forKey: .method)
