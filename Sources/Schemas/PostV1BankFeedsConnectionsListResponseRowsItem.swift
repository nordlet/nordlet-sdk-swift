...
public struct PostV1BankFeedsConnectionsListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let provider: String
    public let aspspName: String
    public let aspspCountry: String
    public let psuType: PostV1BankFeedsConnectionsListResponseRowsItemPsuType
    public let status: PostV1BankFeedsConnectionsListResponseRowsItemStatus
    ...
    public init(
        ...
        aspspName: String,
        aspspCountry: String,
        psuType: PostV1BankFeedsConnectionsListResponseRowsItemPsuType,
        status: PostV1BankFeedsConnectionsListResponseRowsItemStatus,
        reference: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.psuType = try container.decode(PostV1BankFeedsConnectionsListResponseRowsItemPsuType.self, forKey: .psuType)
        self.status = try container.decode(PostV1BankFeedsConnectionsListResponseRowsItemStatus.self, forKey: .status)
