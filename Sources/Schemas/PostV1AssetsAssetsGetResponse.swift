...
public struct PostV1AssetsAssetsGetResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1AssetsAssetsGetResponseStatus
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1AssetsAssetsGetResponseStatus.self, forKey: .status)
