...
public struct PostV1PurchasesOrdersListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let status: PostV1PurchasesOrdersListResponseRowsItemStatus
    ...
    public init(
        id: String,
        partnerId: String,
        status: PostV1PurchasesOrdersListResponseRowsItemStatus,
        orderNumber: String,
        orderDate: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PurchasesOrdersListResponseRowsItemStatus.self, forKey: .status)
