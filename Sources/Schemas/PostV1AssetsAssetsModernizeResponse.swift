...
public struct PostV1AssetsAssetsModernizeResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1AssetsAssetsModernizeResponseStatus
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1AssetsAssetsModernizeResponseStatus.self, forKey: .status)
