...
public struct PostV1ProductionMaintenanceCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let workCenterId: String
    public let type: PostV1ProductionMaintenanceCreateResponseType
    public let status: PostV1ProductionMaintenanceCreateResponseStatus
    ...
    public init(
        id: String,
        workCenterId: String,
        type: PostV1ProductionMaintenanceCreateResponseType,
        status: PostV1ProductionMaintenanceCreateResponseStatus,
        plannedDate: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1ProductionMaintenanceCreateResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1ProductionMaintenanceCreateResponseStatus.self, forKey: .status)
