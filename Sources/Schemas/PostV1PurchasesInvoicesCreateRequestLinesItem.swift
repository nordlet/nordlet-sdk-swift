...
public struct PostV1PurchasesInvoicesCreateRequestLinesItem: Codable, Hashable, Sendable {
    public let itemId: String?
    public let description: String?
    public let unit: String?
    public let quantity: PostV1PurchasesInvoicesCreateRequestLinesItemQuantity?
    ...
    public init(
        ...
        unit: String? = nil,
        quantity: PostV1PurchasesInvoicesCreateRequestLinesItemQuantity? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.quantity = try container.decodeIfPresent(PostV1PurchasesInvoicesCreateRequestLinesItemQuantity.self, forKey: .quantity)
