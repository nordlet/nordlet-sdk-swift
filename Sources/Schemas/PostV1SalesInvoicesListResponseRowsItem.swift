...
public struct PostV1SalesInvoicesListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesInvoicesListResponseRowsItemType
    public let status: PostV1SalesInvoicesListResponseRowsItemStatus
    public let paymentStatus: PostV1SalesInvoicesListResponseRowsItemPaymentStatus
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesInvoicesListResponseRowsItemType,
        status: PostV1SalesInvoicesListResponseRowsItemStatus,
        paymentStatus: PostV1SalesInvoicesListResponseRowsItemPaymentStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesInvoicesListResponseRowsItemType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesInvoicesListResponseRowsItemStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1SalesInvoicesListResponseRowsItemPaymentStatus.self, forKey: .paymentStatus)
