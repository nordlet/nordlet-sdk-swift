...
public struct PostV1BankMandatesUpdateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let reference: String
    public let scheme: PostV1BankMandatesUpdateResponseScheme
    public let sequenceType: PostV1BankMandatesUpdateResponseSequenceType
    public let status: PostV1BankMandatesUpdateResponseStatus
    ...
    public init(
        ...
        partnerId: String,
        reference: String,
        scheme: PostV1BankMandatesUpdateResponseScheme,
        sequenceType: PostV1BankMandatesUpdateResponseSequenceType,
        status: PostV1BankMandatesUpdateResponseStatus,
        debtorName: String,
        iban: String,
        bic: Nullable<String>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.scheme = try container.decode(PostV1BankMandatesUpdateResponseScheme.self, forKey: .scheme)
        self.sequenceType = try container.decode(PostV1BankMandatesUpdateResponseSequenceType.self, forKey: .sequenceType)
        self.status = try container.decode(PostV1BankMandatesUpdateResponseStatus.self, forKey: .status)
