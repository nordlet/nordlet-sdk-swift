...
public struct PostV1PurchasesInvoicesListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1PurchasesInvoicesListResponseRowsItemType
    public let status: PostV1PurchasesInvoicesListResponseRowsItemStatus
    public let paymentStatus: PostV1PurchasesInvoicesListResponseRowsItemPaymentStatus
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1PurchasesInvoicesListResponseRowsItemType,
        status: PostV1PurchasesInvoicesListResponseRowsItemStatus,
        paymentStatus: PostV1PurchasesInvoicesListResponseRowsItemPaymentStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PurchasesInvoicesListResponseRowsItemType.self, forKey: .type)
        self.status = try container.decode(PostV1PurchasesInvoicesListResponseRowsItemStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1PurchasesInvoicesListResponseRowsItemPaymentStatus.self, forKey: .paymentStatus)
