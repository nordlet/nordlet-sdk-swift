...
public struct PostV1CashOrdersCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1CashOrdersCreateResponseType
    ...
    public init(
        id: String,
        type: PostV1CashOrdersCreateResponseType,
        series: String,
        number: Int64,
        fullNumber: String,
        date: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1CashOrdersCreateResponseType.self, forKey: .type)
