...
public struct PostV1CashOrdersGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1CashOrdersGetResponseType
    ...
    public init(
        id: String,
        type: PostV1CashOrdersGetResponseType,
        series: String,
        number: Int64,
        fullNumber: String,
        date: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1CashOrdersGetResponseType.self, forKey: .type)
