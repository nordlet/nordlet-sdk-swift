...
public struct PostV1DeclarationsLtIsafGenerateResponse: Codable, Hashable, Sendable {
    public let fileName: String
    public let periodStart: String
    public let periodEnd: String
    public let counts: PostV1DeclarationsLtIsafGenerateResponseCounts
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.counts = try container.decode(PostV1DeclarationsLtIsafGenerateResponseCounts.self, forKey: .counts)
