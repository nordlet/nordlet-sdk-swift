...
public struct PostV1HrTimesheetsListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let employeeId: String
    public let employeeName: String
    public let year: Int64
    public let month: Int64
    public let days: [PostV1HrTimesheetsListResponseRowsItemDaysItem]
    ...
    public init(
        ...
        year: Int64,
        month: Int64,
        days: [PostV1HrTimesheetsListResponseRowsItemDaysItem],
        workedDays: String,
        workedHours: String,
        updatedAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.days = try container.decode([PostV1HrTimesheetsListResponseRowsItemDaysItem].self, forKey: .days)
