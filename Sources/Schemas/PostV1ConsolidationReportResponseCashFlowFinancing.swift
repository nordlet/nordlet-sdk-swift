...
public struct PostV1ConsolidationReportResponseCashFlowFinancing: Codable, Hashable, Sendable {
    public let inflow: String
    public let outflow: String
    public let net: String
    public let rows: [PostV1ConsolidationReportResponseCashFlowFinancingRowsItem]
    ...
    public init(
        ...
        outflow: String,
        net: String,
        rows: [PostV1ConsolidationReportResponseCashFlowFinancingRowsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rows = try container.decode([PostV1ConsolidationReportResponseCashFlowFinancingRowsItem].self, forKey: .rows)
