...
public struct PostV1BankMandatesGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let reference: String
    public let scheme: PostV1BankMandatesGetResponseScheme
    public let sequenceType: PostV1BankMandatesGetResponseSequenceType
    public let status: PostV1BankMandatesGetResponseStatus
    ...
    public init(
        ...
        partnerId: String,
        reference: String,
        scheme: PostV1BankMandatesGetResponseScheme,
        sequenceType: PostV1BankMandatesGetResponseSequenceType,
        status: PostV1BankMandatesGetResponseStatus,
        debtorName: String,
        iban: String,
        bic: Nullable<String>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.scheme = try container.decode(PostV1BankMandatesGetResponseScheme.self, forKey: .scheme)
        self.sequenceType = try container.decode(PostV1BankMandatesGetResponseSequenceType.self, forKey: .sequenceType)
        self.status = try container.decode(PostV1BankMandatesGetResponseStatus.self, forKey: .status)
