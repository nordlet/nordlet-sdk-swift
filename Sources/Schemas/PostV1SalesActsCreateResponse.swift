...
public struct PostV1SalesActsCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesActsCreateResponseType
    public let status: PostV1SalesActsCreateResponseStatus
    ...
    public let lines: [PostV1SalesActsCreateResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesActsCreateResponseType,
        status: PostV1SalesActsCreateResponseStatus,
        series: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1SalesActsCreateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesActsCreateResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesActsCreateResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1SalesActsCreateResponseLinesItem].self, forKey: .lines)
