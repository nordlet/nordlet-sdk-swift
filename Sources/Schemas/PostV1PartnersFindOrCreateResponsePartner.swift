...
public struct PostV1PartnersFindOrCreateResponsePartner: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1PartnersFindOrCreateResponsePartnerType
    ...
    public let address: Nullable<PostV1PartnersFindOrCreateResponsePartnerAddress>
    ...
    public init(
        id: String,
        type: PostV1PartnersFindOrCreateResponsePartnerType,
        name: String,
        ...
        address: Nullable<PostV1PartnersFindOrCreateResponsePartnerAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PartnersFindOrCreateResponsePartnerType.self, forKey: .type)
        ...
        self.address = try container.decode(Nullable<PostV1PartnersFindOrCreateResponsePartnerAddress>.self, forKey: .address)
