...
public struct PostV1PurchasesInvoicesGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1PurchasesInvoicesGetResponseType
    public let status: PostV1PurchasesInvoicesGetResponseStatus
    public let paymentStatus: PostV1PurchasesInvoicesGetResponsePaymentStatus
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1PurchasesInvoicesGetResponseType,
        status: PostV1PurchasesInvoicesGetResponseStatus,
        paymentStatus: PostV1PurchasesInvoicesGetResponsePaymentStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PurchasesInvoicesGetResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1PurchasesInvoicesGetResponseStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1PurchasesInvoicesGetResponsePaymentStatus.self, forKey: .paymentStatus)
