...
public struct PostV1HrEmployeesGetResponse: Codable, Hashable, Sendable {
    ...
    public let address: Nullable<PostV1HrEmployeesGetResponseAddress>
    ...
    public let status: PostV1HrEmployeesGetResponseStatus
    ...
    public init(
        ...
        address: Nullable<PostV1HrEmployeesGetResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.address = try container.decode(Nullable<PostV1HrEmployeesGetResponseAddress>.self, forKey: .address)
        ...
        self.status = try container.decode(PostV1HrEmployeesGetResponseStatus.self, forKey: .status)
