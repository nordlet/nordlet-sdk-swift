...
public struct PostV1SalesInvoicesIssueResponseLinesItem: Codable, Hashable, Sendable {
    ...
    public let recognitionMethod: PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod
    public let recognitionStartDate: Nullable<String>
    public let recognitionEndDate: Nullable<String>
    public let recognitionMilestones: Nullable<[PostV1SalesInvoicesIssueResponseLinesItemRecognitionMilestonesItem]>
    ...
    public init(
        ...
        lineGross: String,
        sortOrder: Int64,
        recognitionMethod: PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod,
        recognitionStartDate: Nullable<String>,
        recognitionEndDate: Nullable<String>,
        recognitionMilestones: Nullable<[PostV1SalesInvoicesIssueResponseLinesItemRecognitionMilestonesItem]>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.recognitionMethod = try container.decode(PostV1SalesInvoicesIssueResponseLinesItemRecognitionMethod.self, forKey: .recognitionMethod)
        ...
        self.recognitionMilestones = try container.decode(Nullable<[PostV1SalesInvoicesIssueResponseLinesItemRecognitionMilestonesItem]>.self, forKey: .recognitionMilestones)
