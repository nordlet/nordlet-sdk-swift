...
public struct PostV1PurchasesOrdersSubmitResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let status: PostV1PurchasesOrdersSubmitResponseStatus
    ...
    public let lines: [PostV1PurchasesOrdersSubmitResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        status: PostV1PurchasesOrdersSubmitResponseStatus,
        orderNumber: String,
        orderDate: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1PurchasesOrdersSubmitResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PurchasesOrdersSubmitResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1PurchasesOrdersSubmitResponseLinesItem].self, forKey: .lines)
