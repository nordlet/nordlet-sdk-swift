...
public struct PostV1TransportWaybillsCancelResponse: Codable, Hashable, Sendable {
    public let id: String
    public let status: PostV1TransportWaybillsCancelResponseStatus
    ...
    public init(
        id: String,
        status: PostV1TransportWaybillsCancelResponseStatus,
        series: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1TransportWaybillsCancelResponseStatus.self, forKey: .status)
