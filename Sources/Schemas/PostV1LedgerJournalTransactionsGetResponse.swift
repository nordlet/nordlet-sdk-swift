...
public struct PostV1LedgerJournalTransactionsGetResponse: Codable, Hashable, Sendable {
    ...
    public let entries: [PostV1LedgerJournalTransactionsGetResponseEntriesItem]
    ...
    public init(
        ...
        entries: [PostV1LedgerJournalTransactionsGetResponseEntriesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.entries = try container.decode([PostV1LedgerJournalTransactionsGetResponseEntriesItem].self, forKey: .entries)
