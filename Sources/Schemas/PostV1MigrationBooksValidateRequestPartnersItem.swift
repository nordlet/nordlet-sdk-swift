...
public struct PostV1MigrationBooksValidateRequestPartnersItem: Codable, Hashable, Sendable {
    public let code: String
    public let name: String
    public let type: PostV1MigrationBooksValidateRequestPartnersItemType?
    ...
    public let address: PostV1MigrationBooksValidateRequestPartnersItemAddress?
    ...
    public init(
        code: String,
        name: String,
        type: PostV1MigrationBooksValidateRequestPartnersItemType? = nil,
        vatCode: String? = nil,
        email: String? = nil,
        phone: String? = nil,
        isCustomer: Bool? = nil,
        ...
        address: PostV1MigrationBooksValidateRequestPartnersItemAddress? = nil,
        notes: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decodeIfPresent(PostV1MigrationBooksValidateRequestPartnersItemType.self, forKey: .type)
        ...
        self.address = try container.decodeIfPresent(PostV1MigrationBooksValidateRequestPartnersItemAddress.self, forKey: .address)
