...
public struct PostV1SalesInvoicesIssueResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesInvoicesIssueResponseType
    public let status: PostV1SalesInvoicesIssueResponseStatus
    public let paymentStatus: PostV1SalesInvoicesIssueResponsePaymentStatus
    ...
    public let vatScheme: Nullable<PostV1SalesInvoicesIssueResponseVatScheme>
    ...
    public let vatEvidence: Nullable<PostV1SalesInvoicesIssueResponseVatEvidence>
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesInvoicesIssueResponseType,
        status: PostV1SalesInvoicesIssueResponseStatus,
        paymentStatus: PostV1SalesInvoicesIssueResponsePaymentStatus,
        ...
        vatScheme: Nullable<PostV1SalesInvoicesIssueResponseVatScheme>,
        ...
        vatEvidence: Nullable<PostV1SalesInvoicesIssueResponseVatEvidence>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesInvoicesIssueResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesInvoicesIssueResponseStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1SalesInvoicesIssueResponsePaymentStatus.self, forKey: .paymentStatus)
        ...
        self.vatScheme = try container.decode(Nullable<PostV1SalesInvoicesIssueResponseVatScheme>.self, forKey: .vatScheme)
        ...
        self.vatEvidence = try container.decode(Nullable<PostV1SalesInvoicesIssueResponseVatEvidence>.self, forKey: .vatEvidence)
