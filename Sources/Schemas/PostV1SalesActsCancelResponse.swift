...
public struct PostV1SalesActsCancelResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesActsCancelResponseType
    public let status: PostV1SalesActsCancelResponseStatus
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesActsCancelResponseType,
        status: PostV1SalesActsCancelResponseStatus,
        series: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesActsCancelResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesActsCancelResponseStatus.self, forKey: .status)
