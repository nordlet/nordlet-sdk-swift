...
public struct PostV1PurchasesOrdersCreateRequestLinesItem: Codable, Hashable, Sendable {
    public let itemId: String?
    public let description: String?
    public let unit: String?
    public let quantity: PostV1PurchasesOrdersCreateRequestLinesItemQuantity?
    ...
    public init(
        ...
        unit: String? = nil,
        quantity: PostV1PurchasesOrdersCreateRequestLinesItemQuantity? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.quantity = try container.decodeIfPresent(PostV1PurchasesOrdersCreateRequestLinesItemQuantity.self, forKey: .quantity)
