...
public struct PostV1BankFeedsConnectionsCompleteResponse: Codable, Hashable, Sendable {
    public let id: String
    public let provider: String
    public let aspspName: String
    public let aspspCountry: String
    public let psuType: PostV1BankFeedsConnectionsCompleteResponsePsuType
    public let status: PostV1BankFeedsConnectionsCompleteResponseStatus
    ...
    public let accounts: [PostV1BankFeedsConnectionsCompleteResponseAccountsItem]
    ...
    public init(
        ...
        aspspName: String,
        aspspCountry: String,
        psuType: PostV1BankFeedsConnectionsCompleteResponsePsuType,
        status: PostV1BankFeedsConnectionsCompleteResponseStatus,
        reference: String,
        ...
        createdAt: String,
        updatedAt: String,
        accounts: [PostV1BankFeedsConnectionsCompleteResponseAccountsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.psuType = try container.decode(PostV1BankFeedsConnectionsCompleteResponsePsuType.self, forKey: .psuType)
        self.status = try container.decode(PostV1BankFeedsConnectionsCompleteResponseStatus.self, forKey: .status)
        ...
        self.accounts = try container.decode([PostV1BankFeedsConnectionsCompleteResponseAccountsItem].self, forKey: .accounts)
