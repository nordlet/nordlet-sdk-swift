...
public struct PostV1SalesInvoicesGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesInvoicesGetResponseType
    public let status: PostV1SalesInvoicesGetResponseStatus
    public let paymentStatus: PostV1SalesInvoicesGetResponsePaymentStatus
    ...
    public let vatScheme: Nullable<PostV1SalesInvoicesGetResponseVatScheme>
    public let vatCountryCode: Nullable<String>
    public let deemedSupplier: Bool
    public let notes: Nullable<String>
    public let createdAt: String
    public let updatedAt: String
    public let lines: [PostV1SalesInvoicesGetResponseLinesItem]
    public let vatEvidence: Nullable<PostV1SalesInvoicesGetResponseVatEvidence>
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesInvoicesGetResponseType,
        status: PostV1SalesInvoicesGetResponseStatus,
        paymentStatus: PostV1SalesInvoicesGetResponsePaymentStatus,
        ...
        vatScheme: Nullable<PostV1SalesInvoicesGetResponseVatScheme>,
        vatCountryCode: Nullable<String>,
        deemedSupplier: Bool,
        notes: Nullable<String>,
        createdAt: String,
        updatedAt: String,
        lines: [PostV1SalesInvoicesGetResponseLinesItem],
        vatEvidence: Nullable<PostV1SalesInvoicesGetResponseVatEvidence>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesInvoicesGetResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesInvoicesGetResponseStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1SalesInvoicesGetResponsePaymentStatus.self, forKey: .paymentStatus)
        ...
        self.vatScheme = try container.decode(Nullable<PostV1SalesInvoicesGetResponseVatScheme>.self, forKey: .vatScheme)
        ...
        self.lines = try container.decode([PostV1SalesInvoicesGetResponseLinesItem].self, forKey: .lines)
        self.vatEvidence = try container.decode(Nullable<PostV1SalesInvoicesGetResponseVatEvidence>.self, forKey: .vatEvidence)
