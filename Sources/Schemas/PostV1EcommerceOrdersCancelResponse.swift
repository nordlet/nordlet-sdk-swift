...
public struct PostV1EcommerceOrdersCancelResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1EcommerceOrdersCancelResponseStatus
    ...
    public let lines: [PostV1EcommerceOrdersCancelResponseLinesItem]
    ...
    public init(
        ...
        currency: String,
        status: PostV1EcommerceOrdersCancelResponseStatus,
        invoiceId: Nullable<String>,
        shipToCountryCode: Nullable<String>,
        marketplace: Nullable<String>,
        notes: Nullable<String>,
        createdAt: String,
        lines: [PostV1EcommerceOrdersCancelResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1EcommerceOrdersCancelResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1EcommerceOrdersCancelResponseLinesItem].self, forKey: .lines)
