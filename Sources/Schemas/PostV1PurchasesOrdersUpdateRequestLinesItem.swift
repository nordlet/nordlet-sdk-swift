...
public struct PostV1PurchasesOrdersUpdateRequestLinesItem: Codable, Hashable, Sendable {
    public let itemId: String?
    public let description: String?
    public let unit: String?
    public let quantity: PostV1PurchasesOrdersUpdateRequestLinesItemQuantity?
    ...
    public init(
        ...
        unit: String? = nil,
        quantity: PostV1PurchasesOrdersUpdateRequestLinesItemQuantity? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.quantity = try container.decodeIfPresent(PostV1PurchasesOrdersUpdateRequestLinesItemQuantity.self, forKey: .quantity)
