...
public struct PostV1AccountCompaniesProfileResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1AccountCompaniesProfileResponseStatus
    public let address: Nullable<PostV1AccountCompaniesProfileResponseAddress>
    ...
    public init(
        ...
        status: PostV1AccountCompaniesProfileResponseStatus,
        address: Nullable<PostV1AccountCompaniesProfileResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1AccountCompaniesProfileResponseStatus.self, forKey: .status)
        self.address = try container.decode(Nullable<PostV1AccountCompaniesProfileResponseAddress>.self, forKey: .address)
