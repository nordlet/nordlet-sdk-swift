...
public struct PostV1ReportsCashFlowResponseInvesting: Codable, Hashable, Sendable {
    public let inflow: String
    public let outflow: String
    public let net: String
    public let rows: [PostV1ReportsCashFlowResponseInvestingRowsItem]
    ...
    public init(
        ...
        outflow: String,
        net: String,
        rows: [PostV1ReportsCashFlowResponseInvestingRowsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rows = try container.decode([PostV1ReportsCashFlowResponseInvestingRowsItem].self, forKey: .rows)
