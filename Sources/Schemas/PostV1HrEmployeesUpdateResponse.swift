...
public struct PostV1HrEmployeesUpdateResponse: Codable, Hashable, Sendable {
    ...
    public let address: Nullable<PostV1HrEmployeesUpdateResponseAddress>
    ...
    public init(
        ...
        address: Nullable<PostV1HrEmployeesUpdateResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.address = try container.decode(Nullable<PostV1HrEmployeesUpdateResponseAddress>.self, forKey: .address)
