...
public struct PostV1EcommerceOrdersFulfillResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1EcommerceOrdersFulfillResponseStatus
    ...
    public let lines: [PostV1EcommerceOrdersFulfillResponseLinesItem]
    ...
    public init(
        ...
        currency: String,
        status: PostV1EcommerceOrdersFulfillResponseStatus,
        invoiceId: Nullable<String>,
        shipToCountryCode: Nullable<String>,
        marketplace: Nullable<String>,
        notes: Nullable<String>,
        createdAt: String,
        lines: [PostV1EcommerceOrdersFulfillResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1EcommerceOrdersFulfillResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1EcommerceOrdersFulfillResponseLinesItem].self, forKey: .lines)
