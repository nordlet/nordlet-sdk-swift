...
public struct PostV1DeclarationsSubmissionsListResponseRowsItem: Codable, Hashable, Sendable {
    ...
    public let status: PostV1DeclarationsSubmissionsListResponseRowsItemStatus
    ...
    public init(
        ...
        status: PostV1DeclarationsSubmissionsListResponseRowsItemStatus,
        fileName: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1DeclarationsSubmissionsListResponseRowsItemStatus.self, forKey: .status)
