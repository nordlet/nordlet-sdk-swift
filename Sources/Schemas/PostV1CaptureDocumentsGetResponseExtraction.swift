...
public struct PostV1CaptureDocumentsGetResponseExtraction: Codable, Hashable, Sendable {
    public let supplier: PostV1CaptureDocumentsGetResponseExtractionSupplier
    ...
    public let lines: [PostV1CaptureDocumentsGetResponseExtractionLinesItem]
    ...
    public init(
        ...
        lines: [PostV1CaptureDocumentsGetResponseExtractionLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.supplier = try container.decode(PostV1CaptureDocumentsGetResponseExtractionSupplier.self, forKey: .supplier)
        ...
        self.lines = try container.decode([PostV1CaptureDocumentsGetResponseExtractionLinesItem].self, forKey: .lines)
