...
public struct PostV1HrEmployeesRecordsCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let employeeId: String
    public let type: PostV1HrEmployeesRecordsCreateResponseType
    ...
    public init(
        id: String,
        employeeId: String,
        type: PostV1HrEmployeesRecordsCreateResponseType,
        title: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1HrEmployeesRecordsCreateResponseType.self, forKey: .type)
