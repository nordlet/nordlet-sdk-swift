...
public struct PostV1DeclarationsSubmissionsCreateResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1DeclarationsSubmissionsCreateResponseStatus
    ...
    public init(
        ...
        status: PostV1DeclarationsSubmissionsCreateResponseStatus,
        fileName: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1DeclarationsSubmissionsCreateResponseStatus.self, forKey: .status)
