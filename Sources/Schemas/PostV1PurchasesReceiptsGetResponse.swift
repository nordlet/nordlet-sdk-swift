...
public struct PostV1PurchasesReceiptsGetResponse: Codable, Hashable, Sendable {
    ...
    public let lines: [PostV1PurchasesReceiptsGetResponseLinesItem]
    ...
    public init(
        ...
        createdAt: String,
        lines: [PostV1PurchasesReceiptsGetResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.lines = try container.decode([PostV1PurchasesReceiptsGetResponseLinesItem].self, forKey: .lines)
