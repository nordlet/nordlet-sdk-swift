...
public struct PostV1AgreementsAgreementsCreateResponse: Codable, Hashable, Sendable {
    ...
    public let billingPeriod: Nullable<PostV1AgreementsAgreementsCreateResponseBillingPeriod>
    ...
    public init(
        ...
        billingPeriod: Nullable<PostV1AgreementsAgreementsCreateResponseBillingPeriod>,
        currency: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.billingPeriod = try container.decode(Nullable<PostV1AgreementsAgreementsCreateResponseBillingPeriod>.self, forKey: .billingPeriod)
