...
public struct PostV1HrTimesheetsUpsertResponse: Codable, Hashable, Sendable {
    public let id: String
    public let employeeId: String
    public let employeeName: String
    public let year: Int64
    public let month: Int64
    public let days: [PostV1HrTimesheetsUpsertResponseDaysItem]
    ...
    public init(
        ...
        year: Int64,
        month: Int64,
        days: [PostV1HrTimesheetsUpsertResponseDaysItem],
        workedDays: String,
        workedHours: String,
        updatedAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.days = try container.decode([PostV1HrTimesheetsUpsertResponseDaysItem].self, forKey: .days)
