...
public struct PostV1EcommerceOrdersListResponseRowsItem: Codable, Hashable, Sendable {
    ...
    public let status: PostV1EcommerceOrdersListResponseRowsItemStatus
    ...
    public init(
        ...
        currency: String,
        status: PostV1EcommerceOrdersListResponseRowsItemStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1EcommerceOrdersListResponseRowsItemStatus.self, forKey: .status)
