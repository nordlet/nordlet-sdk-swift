...
public struct PostV1InventoryLotsGetResponse: Codable, Hashable, Sendable {
    ...
    public let movements: [PostV1InventoryLotsGetResponseMovementsItem]
    ...
    public init(
        ...
        onHand: String,
        createdAt: String,
        movements: [PostV1InventoryLotsGetResponseMovementsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.movements = try container.decode([PostV1InventoryLotsGetResponseMovementsItem].self, forKey: .movements)
