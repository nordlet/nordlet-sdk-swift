...
public struct PostV1PosReportsGetResponse: Codable, Hashable, Sendable {
    ...
    public let vatLines: [PostV1PosReportsGetResponseVatLinesItem]
    ...
    public init(
        ...
        createdAt: String,
        vatLines: [PostV1PosReportsGetResponseVatLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.vatLines = try container.decode([PostV1PosReportsGetResponseVatLinesItem].self, forKey: .vatLines)
