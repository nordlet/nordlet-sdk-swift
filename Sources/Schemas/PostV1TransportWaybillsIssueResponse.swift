...
public struct PostV1TransportWaybillsIssueResponse: Codable, Hashable, Sendable {
    public let id: String
    public let status: PostV1TransportWaybillsIssueResponseStatus
    ...
    public let lines: [PostV1TransportWaybillsIssueResponseLinesItem]
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        id: String,
        status: PostV1TransportWaybillsIssueResponseStatus,
        series: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1TransportWaybillsIssueResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1TransportWaybillsIssueResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1TransportWaybillsIssueResponseLinesItem].self, forKey: .lines)
