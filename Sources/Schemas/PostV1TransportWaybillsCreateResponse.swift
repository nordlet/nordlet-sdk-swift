...
public struct PostV1TransportWaybillsCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let status: PostV1TransportWaybillsCreateResponseStatus
    ...
    public let lines: [PostV1TransportWaybillsCreateResponseLinesItem]
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        id: String,
        status: PostV1TransportWaybillsCreateResponseStatus,
        series: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1TransportWaybillsCreateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1TransportWaybillsCreateResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1TransportWaybillsCreateResponseLinesItem].self, forKey: .lines)
