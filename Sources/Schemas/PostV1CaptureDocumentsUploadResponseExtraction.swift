...
public struct PostV1CaptureDocumentsUploadResponseExtraction: Codable, Hashable, Sendable {
    public let supplier: PostV1CaptureDocumentsUploadResponseExtractionSupplier
    ...
    public let lines: [PostV1CaptureDocumentsUploadResponseExtractionLinesItem]
    ...
    public init(
        ...
        lines: [PostV1CaptureDocumentsUploadResponseExtractionLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.supplier = try container.decode(PostV1CaptureDocumentsUploadResponseExtractionSupplier.self, forKey: .supplier)
        ...
        self.lines = try container.decode([PostV1CaptureDocumentsUploadResponseExtractionLinesItem].self, forKey: .lines)
