...
public struct PostV1ReportsCashFlowResponseFinancing: Codable, Hashable, Sendable {
    public let inflow: String
    public let outflow: String
    public let net: String
    public let rows: [PostV1ReportsCashFlowResponseFinancingRowsItem]
    ...
    public init(
        ...
        outflow: String,
        net: String,
        rows: [PostV1ReportsCashFlowResponseFinancingRowsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rows = try container.decode([PostV1ReportsCashFlowResponseFinancingRowsItem].self, forKey: .rows)
