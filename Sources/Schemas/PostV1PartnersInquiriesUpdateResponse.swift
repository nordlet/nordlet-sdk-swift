...
public struct PostV1PartnersInquiriesUpdateResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1PartnersInquiriesUpdateResponseStatus
    ...
    public init(
        ...
        channel: String,
        status: PostV1PartnersInquiriesUpdateResponseStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PartnersInquiriesUpdateResponseStatus.self, forKey: .status)
