...
public struct PostV1PurchasesOrdersGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let status: PostV1PurchasesOrdersGetResponseStatus
    ...
    public let lines: [PostV1PurchasesOrdersGetResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        status: PostV1PurchasesOrdersGetResponseStatus,
        orderNumber: String,
        orderDate: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1PurchasesOrdersGetResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PurchasesOrdersGetResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1PurchasesOrdersGetResponseLinesItem].self, forKey: .lines)
