...
public struct PostV1HrEmployeesCreateResponse: Codable, Hashable, Sendable {
    ...
    public let address: Nullable<PostV1HrEmployeesCreateResponseAddress>
    ...
    public let status: PostV1HrEmployeesCreateResponseStatus
    ...
    public init(
        ...
        address: Nullable<PostV1HrEmployeesCreateResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.address = try container.decode(Nullable<PostV1HrEmployeesCreateResponseAddress>.self, forKey: .address)
        ...
        self.status = try container.decode(PostV1HrEmployeesCreateResponseStatus.self, forKey: .status)
