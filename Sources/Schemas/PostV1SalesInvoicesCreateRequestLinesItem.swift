...
public struct PostV1SalesInvoicesCreateRequestLinesItem: Codable, Hashable, Sendable {
    public let itemId: String?
    public let description: String?
    public let unit: String?
    public let quantity: PostV1SalesInvoicesCreateRequestLinesItemQuantity?
    ...
    public init(
        ...
        unit: String? = nil,
        quantity: PostV1SalesInvoicesCreateRequestLinesItemQuantity? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.quantity = try container.decodeIfPresent(PostV1SalesInvoicesCreateRequestLinesItemQuantity.self, forKey: .quantity)
