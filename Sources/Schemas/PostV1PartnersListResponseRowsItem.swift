...
public struct PostV1PartnersListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1PartnersListResponseRowsItemType
    ...
    public let address: Nullable<PostV1PartnersListResponseRowsItemAddress>
    ...
    public init(
        id: String,
        type: PostV1PartnersListResponseRowsItemType,
        name: String,
        ...
        address: Nullable<PostV1PartnersListResponseRowsItemAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PartnersListResponseRowsItemType.self, forKey: .type)
        ...
        self.address = try container.decode(Nullable<PostV1PartnersListResponseRowsItemAddress>.self, forKey: .address)
