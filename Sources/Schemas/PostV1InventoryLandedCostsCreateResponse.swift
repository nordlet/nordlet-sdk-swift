...
public struct PostV1InventoryLandedCostsCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let date: String
    public let amount: String
    public let method: PostV1InventoryLandedCostsCreateResponseMethod
    public let goodsReceiptId: Nullable<String>
    public let sourceInvoiceId: Nullable<String>
    public let notes: Nullable<String>
    public let createdAt: String
    public let lines: [PostV1InventoryLandedCostsCreateResponseLinesItem]
    ...
    public init(
        ...
        date: String,
        amount: String,
        method: PostV1InventoryLandedCostsCreateResponseMethod,
        goodsReceiptId: Nullable<String>,
        sourceInvoiceId: Nullable<String>,
        notes: Nullable<String>,
        createdAt: String,
        lines: [PostV1InventoryLandedCostsCreateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.method = try container.decode(PostV1InventoryLandedCostsCreateResponseMethod.self, forKey: .method)
        ...
        self.lines = try container.decode([PostV1InventoryLandedCostsCreateResponseLinesItem].self, forKey: .lines)
