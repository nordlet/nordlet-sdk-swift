...
public struct PostV1PurchasesOrdersApproveResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let status: PostV1PurchasesOrdersApproveResponseStatus
    ...
    public let lines: [PostV1PurchasesOrdersApproveResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        status: PostV1PurchasesOrdersApproveResponseStatus,
        orderNumber: String,
        orderDate: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1PurchasesOrdersApproveResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PurchasesOrdersApproveResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1PurchasesOrdersApproveResponseLinesItem].self, forKey: .lines)
