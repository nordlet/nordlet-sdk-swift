...
public struct PostV1ConsolidationReportResponseCashFlowInvesting: Codable, Hashable, Sendable {
    public let inflow: String
    public let outflow: String
    public let net: String
    public let rows: [PostV1ConsolidationReportResponseCashFlowInvestingRowsItem]
    ...
    public init(
        ...
        outflow: String,
        net: String,
        rows: [PostV1ConsolidationReportResponseCashFlowInvestingRowsItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rows = try container.decode([PostV1ConsolidationReportResponseCashFlowInvestingRowsItem].self, forKey: .rows)
