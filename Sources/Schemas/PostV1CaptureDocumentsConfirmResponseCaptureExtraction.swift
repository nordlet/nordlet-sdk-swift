...
public struct PostV1CaptureDocumentsConfirmResponseCaptureExtraction: Codable, Hashable, Sendable {
    public let supplier: PostV1CaptureDocumentsConfirmResponseCaptureExtractionSupplier
    ...
    public let lines: [PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem]
    ...
    public init(
        ...
        lines: [PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.supplier = try container.decode(PostV1CaptureDocumentsConfirmResponseCaptureExtractionSupplier.self, forKey: .supplier)
        ...
        self.lines = try container.decode([PostV1CaptureDocumentsConfirmResponseCaptureExtractionLinesItem].self, forKey: .lines)
