...
public struct PostV1DeclarationsEuOssComputeResponseRowsItem: Codable, Hashable, Sendable {
    public let countryCode: String
    public let rateType: PostV1DeclarationsEuOssComputeResponseRowsItemRateType
    ...
    public init(
        countryCode: String,
        rateType: PostV1DeclarationsEuOssComputeResponseRowsItemRateType,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rateType = try container.decode(PostV1DeclarationsEuOssComputeResponseRowsItemRateType.self, forKey: .rateType)
