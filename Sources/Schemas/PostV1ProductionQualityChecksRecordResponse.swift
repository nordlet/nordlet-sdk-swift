...
public struct PostV1ProductionQualityChecksRecordResponse: Codable, Hashable, Sendable {
    public let id: String
    public let orderId: String
    public let routingOperationId: Nullable<String>
    public let name: String
    public let result: PostV1ProductionQualityChecksRecordResponseResult
    ...
    public init(
        ...
        name: String,
        result: PostV1ProductionQualityChecksRecordResponseResult,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.result = try container.decode(PostV1ProductionQualityChecksRecordResponseResult.self, forKey: .result)
