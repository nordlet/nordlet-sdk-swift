...
public struct PostV1PartnersInquiriesListResponseRowsItem: Codable, Hashable, Sendable {
    ...
    public let status: PostV1PartnersInquiriesListResponseRowsItemStatus
    ...
    public init(
        ...
        channel: String,
        status: PostV1PartnersInquiriesListResponseRowsItemStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1PartnersInquiriesListResponseRowsItemStatus.self, forKey: .status)
