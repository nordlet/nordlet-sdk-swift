...
public struct PostV1ReportsJobsListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let reportType: String
    public let params: JSONValue
    public let formats: [String]
    public let status: PostV1ReportsJobsListResponseRowsItemStatus
    public let error: Nullable<String>
    public let outputs: Nullable<[PostV1ReportsJobsListResponseRowsItemOutputsItem]>
    ...
    public init(
        ...
        params: JSONValue,
        formats: [String],
        status: PostV1ReportsJobsListResponseRowsItemStatus,
        error: Nullable<String>,
        outputs: Nullable<[PostV1ReportsJobsListResponseRowsItemOutputsItem]>,
        createdAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1ReportsJobsListResponseRowsItemStatus.self, forKey: .status)
        self.error = try container.decode(Nullable<String>.self, forKey: .error)
        self.outputs = try container.decode(Nullable<[PostV1ReportsJobsListResponseRowsItemOutputsItem]>.self, forKey: .outputs)
