...
public struct PostV1SalesActsUpdateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesActsUpdateResponseType
    public let status: PostV1SalesActsUpdateResponseStatus
    ...
    public let lines: [PostV1SalesActsUpdateResponseLinesItem]
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesActsUpdateResponseType,
        status: PostV1SalesActsUpdateResponseStatus,
        series: String,
        ...
        createdAt: String,
        updatedAt: String,
        lines: [PostV1SalesActsUpdateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesActsUpdateResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesActsUpdateResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1SalesActsUpdateResponseLinesItem].self, forKey: .lines)
