...
public struct PostV1PartnersUpdateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1PartnersUpdateResponseType
    ...
    public let address: Nullable<PostV1PartnersUpdateResponseAddress>
    ...
    public init(
        id: String,
        type: PostV1PartnersUpdateResponseType,
        name: String,
        ...
        address: Nullable<PostV1PartnersUpdateResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PartnersUpdateResponseType.self, forKey: .type)
        ...
        self.address = try container.decode(Nullable<PostV1PartnersUpdateResponseAddress>.self, forKey: .address)
