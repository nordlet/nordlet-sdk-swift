...
public struct PostV1SalesInvoicesApplyAdvanceResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let type: PostV1SalesInvoicesApplyAdvanceResponseType
    public let status: PostV1SalesInvoicesApplyAdvanceResponseStatus
    public let paymentStatus: PostV1SalesInvoicesApplyAdvanceResponsePaymentStatus
    ...
    public let vatScheme: Nullable<PostV1SalesInvoicesApplyAdvanceResponseVatScheme>
    ...
    public init(
        id: String,
        partnerId: String,
        type: PostV1SalesInvoicesApplyAdvanceResponseType,
        status: PostV1SalesInvoicesApplyAdvanceResponseStatus,
        paymentStatus: PostV1SalesInvoicesApplyAdvanceResponsePaymentStatus,
        ...
        vatScheme: Nullable<PostV1SalesInvoicesApplyAdvanceResponseVatScheme>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1SalesInvoicesApplyAdvanceResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1SalesInvoicesApplyAdvanceResponseStatus.self, forKey: .status)
        self.paymentStatus = try container.decode(PostV1SalesInvoicesApplyAdvanceResponsePaymentStatus.self, forKey: .paymentStatus)
        ...
        self.vatScheme = try container.decode(Nullable<PostV1SalesInvoicesApplyAdvanceResponseVatScheme>.self, forKey: .vatScheme)
