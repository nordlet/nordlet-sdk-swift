...
public struct PostV1PurchasesReceiptsCreateResponse: Codable, Hashable, Sendable {
    ...
    public let lines: [PostV1PurchasesReceiptsCreateResponseLinesItem]
    ...
    public init(
        ...
        createdAt: String,
        lines: [PostV1PurchasesReceiptsCreateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.lines = try container.decode([PostV1PurchasesReceiptsCreateResponseLinesItem].self, forKey: .lines)
