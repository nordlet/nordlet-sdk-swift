...
public struct PostV1BankMandatesCreateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let partnerId: String
    public let reference: String
    public let scheme: PostV1BankMandatesCreateResponseScheme
    public let sequenceType: PostV1BankMandatesCreateResponseSequenceType
    public let status: PostV1BankMandatesCreateResponseStatus
    ...
    public init(
        ...
        partnerId: String,
        reference: String,
        scheme: PostV1BankMandatesCreateResponseScheme,
        sequenceType: PostV1BankMandatesCreateResponseSequenceType,
        status: PostV1BankMandatesCreateResponseStatus,
        debtorName: String,
        iban: String,
        bic: Nullable<String>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.scheme = try container.decode(PostV1BankMandatesCreateResponseScheme.self, forKey: .scheme)
        self.sequenceType = try container.decode(PostV1BankMandatesCreateResponseSequenceType.self, forKey: .sequenceType)
        self.status = try container.decode(PostV1BankMandatesCreateResponseStatus.self, forKey: .status)
