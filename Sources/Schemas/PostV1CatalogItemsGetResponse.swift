...
public struct PostV1CatalogItemsGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1CatalogItemsGetResponseType
    public let tracking: PostV1CatalogItemsGetResponseTracking
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1CatalogItemsGetResponseType.self, forKey: .type)
        self.tracking = try container.decode(PostV1CatalogItemsGetResponseTracking.self, forKey: .tracking)
