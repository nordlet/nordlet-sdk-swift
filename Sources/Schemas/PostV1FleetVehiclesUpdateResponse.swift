...
public struct PostV1FleetVehiclesUpdateResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1FleetVehiclesUpdateResponseStatus
    public let notes: Nullable<String>
    public let currentAssignment: Nullable<PostV1FleetVehiclesUpdateResponseCurrentAssignment>
    ...
    public init(
        ...
        currentAssignment: Nullable<PostV1FleetVehiclesUpdateResponseCurrentAssignment>,
        createdAt: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1FleetVehiclesUpdateResponseStatus.self, forKey: .status)
        self.notes = try container.decode(Nullable<String>.self, forKey: .notes)
        self.currentAssignment = try container.decode(Nullable<PostV1FleetVehiclesUpdateResponseCurrentAssignment>.self, forKey: .currentAssignment)
