...
public struct PostV1BankSettlementsListResponseRowsItem: Codable, Hashable, Sendable {
    ...
    public let status: PostV1BankSettlementsListResponseRowsItemStatus
    ...
    public init(
        ...
        feeTotal: String,
        netTotal: String,
        status: PostV1BankSettlementsListResponseRowsItemStatus,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1BankSettlementsListResponseRowsItemStatus.self, forKey: .status)
