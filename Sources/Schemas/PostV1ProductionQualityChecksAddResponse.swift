...
public struct PostV1ProductionQualityChecksAddResponse: Codable, Hashable, Sendable {
    public let id: String
    public let orderId: String
    public let routingOperationId: Nullable<String>
    public let name: String
    public let result: PostV1ProductionQualityChecksAddResponseResult
    ...
    public init(
        ...
        name: String,
        result: PostV1ProductionQualityChecksAddResponseResult,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.result = try container.decode(PostV1ProductionQualityChecksAddResponseResult.self, forKey: .result)
