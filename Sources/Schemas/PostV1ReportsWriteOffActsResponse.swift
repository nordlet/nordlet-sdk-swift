...
public struct PostV1ReportsWriteOffActsResponse: Codable, Hashable, Sendable {
    public let fromDate: String
    public let toDate: String
    public let rows: [PostV1ReportsWriteOffActsResponseRowsItem]
    ...
    public init(
        fromDate: String,
        toDate: String,
        rows: [PostV1ReportsWriteOffActsResponseRowsItem],
        totalCost: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rows = try container.decode([PostV1ReportsWriteOffActsResponseRowsItem].self, forKey: .rows)
