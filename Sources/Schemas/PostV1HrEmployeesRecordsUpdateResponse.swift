...
public struct PostV1HrEmployeesRecordsUpdateResponse: Codable, Hashable, Sendable {
    public let id: String
    public let employeeId: String
    public let type: PostV1HrEmployeesRecordsUpdateResponseType
    ...
    public init(
        id: String,
        employeeId: String,
        type: PostV1HrEmployeesRecordsUpdateResponseType,
        title: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1HrEmployeesRecordsUpdateResponseType.self, forKey: .type)
