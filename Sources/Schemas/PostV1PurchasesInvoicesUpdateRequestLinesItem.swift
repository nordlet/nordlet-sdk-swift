...
public struct PostV1PurchasesInvoicesUpdateRequestLinesItem: Codable, Hashable, Sendable {
    public let itemId: String?
    public let description: String?
    public let unit: String?
    public let quantity: PostV1PurchasesInvoicesUpdateRequestLinesItemQuantity?
    ...
    public init(
        ...
        unit: String? = nil,
        quantity: PostV1PurchasesInvoicesUpdateRequestLinesItemQuantity? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.quantity = try container.decodeIfPresent(PostV1PurchasesInvoicesUpdateRequestLinesItemQuantity.self, forKey: .quantity)
