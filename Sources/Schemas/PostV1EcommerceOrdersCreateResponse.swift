...
public struct PostV1EcommerceOrdersCreateResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1EcommerceOrdersCreateResponseStatus
    ...
    public let lines: [PostV1EcommerceOrdersCreateResponseLinesItem]
    ...
    public init(
        ...
        currency: String,
        status: PostV1EcommerceOrdersCreateResponseStatus,
        invoiceId: Nullable<String>,
        shipToCountryCode: Nullable<String>,
        marketplace: Nullable<String>,
        notes: Nullable<String>,
        createdAt: String,
        lines: [PostV1EcommerceOrdersCreateResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1EcommerceOrdersCreateResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1EcommerceOrdersCreateResponseLinesItem].self, forKey: .lines)
