...
public struct PostV1SalesInvoicesApplyAdvanceResponseLinesItem: Codable, Hashable, Sendable {
    ...
    public let recognitionMethod: PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod
    public let recognitionStartDate: Nullable<String>
    public let recognitionEndDate: Nullable<String>
    public let recognitionMilestones: Nullable<[PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMilestonesItem]>
    ...
    public init(
        ...
        lineGross: String,
        sortOrder: Int64,
        recognitionMethod: PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod,
        recognitionStartDate: Nullable<String>,
        recognitionEndDate: Nullable<String>,
        recognitionMilestones: Nullable<[PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMilestonesItem]>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.recognitionMethod = try container.decode(PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMethod.self, forKey: .recognitionMethod)
        ...
        self.recognitionMilestones = try container.decode(Nullable<[PostV1SalesInvoicesApplyAdvanceResponseLinesItemRecognitionMilestonesItem]>.self, forKey: .recognitionMilestones)
