...
public struct PostV1EcommerceOrdersGetResponse: Codable, Hashable, Sendable {
    ...
    public let status: PostV1EcommerceOrdersGetResponseStatus
    ...
    public let lines: [PostV1EcommerceOrdersGetResponseLinesItem]
    ...
    public init(
        ...
        currency: String,
        status: PostV1EcommerceOrdersGetResponseStatus,
        invoiceId: Nullable<String>,
        shipToCountryCode: Nullable<String>,
        marketplace: Nullable<String>,
        notes: Nullable<String>,
        createdAt: String,
        lines: [PostV1EcommerceOrdersGetResponseLinesItem],
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.status = try container.decode(PostV1EcommerceOrdersGetResponseStatus.self, forKey: .status)
        ...
        self.lines = try container.decode([PostV1EcommerceOrdersGetResponseLinesItem].self, forKey: .lines)
