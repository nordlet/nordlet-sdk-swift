...
public struct PostV1SalesInvoicesUpdateResponseLinesItem: Codable, Hashable, Sendable {
    ...
    public let recognitionMethod: PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod
    public let recognitionStartDate: Nullable<String>
    public let recognitionEndDate: Nullable<String>
    public let recognitionMilestones: Nullable<[PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem]>
    ...
    public init(
        ...
        lineGross: String,
        sortOrder: Int64,
        recognitionMethod: PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod,
        recognitionStartDate: Nullable<String>,
        recognitionEndDate: Nullable<String>,
        recognitionMilestones: Nullable<[PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem]>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.recognitionMethod = try container.decode(PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod.self, forKey: .recognitionMethod)
        ...
        self.recognitionMilestones = try container.decode(Nullable<[PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem]>.self, forKey: .recognitionMilestones)
