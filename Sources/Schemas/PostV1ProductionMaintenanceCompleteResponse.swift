...
public struct PostV1ProductionMaintenanceCompleteResponse: Codable, Hashable, Sendable {
    public let id: String
    public let workCenterId: String
    public let type: PostV1ProductionMaintenanceCompleteResponseType
    public let status: PostV1ProductionMaintenanceCompleteResponseStatus
    ...
    public init(
        id: String,
        workCenterId: String,
        type: PostV1ProductionMaintenanceCompleteResponseType,
        status: PostV1ProductionMaintenanceCompleteResponseStatus,
        plannedDate: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1ProductionMaintenanceCompleteResponseType.self, forKey: .type)
        self.status = try container.decode(PostV1ProductionMaintenanceCompleteResponseStatus.self, forKey: .status)
