...
public struct PostV1ProductionQualityChecksListResponseRowsItem: Codable, Hashable, Sendable {
    public let id: String
    public let orderId: String
    public let routingOperationId: Nullable<String>
    public let name: String
    public let result: PostV1ProductionQualityChecksListResponseRowsItemResult
    ...
    public init(
        ...
        name: String,
        result: PostV1ProductionQualityChecksListResponseRowsItemResult,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.result = try container.decode(PostV1ProductionQualityChecksListResponseRowsItemResult.self, forKey: .result)
