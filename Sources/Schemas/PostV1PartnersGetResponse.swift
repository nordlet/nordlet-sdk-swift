...
public struct PostV1PartnersGetResponse: Codable, Hashable, Sendable {
    public let id: String
    public let type: PostV1PartnersGetResponseType
    ...
    public let address: Nullable<PostV1PartnersGetResponseAddress>
    ...
    public init(
        id: String,
        type: PostV1PartnersGetResponseType,
        name: String,
        ...
        address: Nullable<PostV1PartnersGetResponseAddress>,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(PostV1PartnersGetResponseType.self, forKey: .type)
        ...
        self.address = try container.decode(Nullable<PostV1PartnersGetResponseAddress>.self, forKey: .address)
